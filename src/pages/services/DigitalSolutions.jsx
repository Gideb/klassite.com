...
// ------------- Main Component -------------
const DigitalSolutions = ({ color = "purple" }) => {
  const colorStyles = {
    purple: {
      bg: "bg-purple-100",
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section
        className={`relative overflow-hidden bg-linear-to-br ${selectedColor.gradientFrom} via-white ${selectedColor.gradientTo} pt-32 pb-5`}
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto ">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 tracking-tight pt-10">
              Digital{" "}
              <span
                className={`bg-linear-to-r  from-purple-200 to-purple-300 bg-clip-text text-transparent`}
              >
                Solutions
              </span>
            </h1>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <Headings black="Our Digital Services" />
