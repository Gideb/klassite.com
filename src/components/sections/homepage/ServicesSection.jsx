    ...
    >
      ...
      <div className="relative px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 bg-purple-100 text-purple-600 px-4 py-2 rounded-full text-md font-normal w-fit mx-auto lg:mx-0 font-[autography]">
