...
const TestimonialSection = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: "Working with klass koncept was a pleasure. He understood our vision perfectly and delivered beyond expectations. The project was completed on time and within budget.",
      rating: 4,
      image: portrait3,
    },
    {
